 ...
 * generation is published. Reopened provider handles are released after their
 * local facts and operation-binding identities are captured, so verification
 * descriptor use does not grow with batch size. Reopened records must belong
 * to the exact operation plan and physical application
